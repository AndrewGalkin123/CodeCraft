    ...
    return (
        <Row>
            ...
            <Col md={{ span: 20, offset: 3 }}>
                ...
                <Paragraph style={{ fontSize: "16px" }}>Добро пожаловать в раздел "Дополнительная информация" CodeCraft!
                ...
                <Paragraph style={{ fontSize: "16px" }}>Узнайте больше о проектах, над которыми работает команда CodeCraft. М
                ...
                <Paragraph style={{ fontSize: "16px" }}>Исследуйте наши обширные обучающие материалы, предназначенные для программистов всех уровней.
                ...
                <Paragraph style={{ fontSize: "16px" }}>Есть вопросы или предложения? Здесь вы найдете контактную информацию для связи с нами.
                ...
                <Paragraph style={{ fontSize: "16px" }}>Если вы представляете компанию или проект, и вам интересно сотрудничество с CodeCraft,
                    ознакомьтесь с информацией о партнерстве и возможностях сотрудничества.</Paragraph>
                <Title level={4}>5. Социальные Сети:</Title>
                <Paragraph style={{ fontSize: "16px" }}>Присоединяйтесь к нам в социальных сетях! Следите за нашими новостями,
